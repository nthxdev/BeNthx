...
// Videos array for Animated Landing Experience
const videos = [
  {
    id: 1,
    title: "Landing Page Animation",
    src: animatedLandingVideo,
    thumb: animatedLandingVideo, // Using video as thumb for now
    duration: "2:34"
  },
  {
    id: 2,
    title: "UI Morphing Effects",
    src: morphingUIVideo,
  ...
  },
  {
    ...
    src: parallaxScrollVideo,
    thumb: parallaxScrollVideo,
    duration: "3:12"
  }
];

const AnimatedLandingPortfolio = () => {
      ...
      <section className="py-16 text-center">
        <div className="container mx-auto px-4">
          ...
          <p className="text-muted-foreground text-lg">
            from <Link to="/profile/maya-patel" className="hover:text-primary transition-colors font-medium">Maya Patel</Link> – Interactive Landing Pages
          </p>
        </div>
      </section>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="flex flex-col lg:flex-row gap-12 items-center">
              ...
              <div className="flex-1 relative max-w-6xl mx-auto">
                ...
                <div className="absolute -inset-6 bg-gradient-to-br from-green-500/20 via-blue-500/20 to-purple-500/20 rounded-3xl blur-2xl opacity-60" />
            ...
            <div className="mt-20 text-center">
              ...
              <div className="flex justify-center gap-3 mb-16">
                {['gsap', 'scroll', 'animation', 'interactive'].map((tag) => (
                  <span
                    key={tag}
                    className="px-4 py-2 bg-gradient-to-r from-green-500/10 to-blue-500/10 border border-green-500/20 rounded-full text-sm font-medium text-green-600 hover:bg-green-500/20 transition-colors cursor-default"
                  >
                    {tag}
                  </span>
                ))}
                ...
                <div className="relative aspect-video bg-gradient-hero overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity flex items-end justify-between p-4">
                    ...
                    <div className="text-white">
                      ...
                      <h3 className="font-bold text-lg">Morphing Components</h3>
                    </div>
              ...
              <Card className="overflow-hidden group cursor-pointer hover:shadow-lg transition-all">
                <div className="relative aspect-video bg-gradient-hero overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity flex items-end justify-between p-4">
                    ...
                    <div className="text-white">
                      <p className="text-sm opacity-90">Element</p>
                      <h3 className="font-bold text-lg">Parallax Effects</h3>
                    </div>
            ...
            <div className="mt-32">
              ...
              <div className="text-left mb-12">
                ...
                <p className="text-2xl font-bold text-black">see more work of <Link to="/profile/maya-patel" className="hover:text-primary transition-colors">Maya Patel</Link></p>
              </div>
...
export default AnimatedLandingPortfolio;
