...
// Videos array for Fluid Typography Animation
const videos = [
  {
    id: 1,
    title: "Typography Animation",
    src: fluidTypographyVideo,
    thumb: fluidTypographyVideo,
    duration: "2:34"
  },
  {
    id: 2,
    title: "Morphing Components",
    src: morphingUIVideo,
  ...
  },
  {
    ...
    src: particleSystemVideo,
    thumb: particleSystemVideo,
    duration: "3:12"
  }
];

const FluidTypographyPortfolio = () => {
      ...
      <section className="py-16 text-center">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            Fluid Typography Animation
          </h1>
          <p className="text-muted-foreground text-lg">
            from <Link to="/profile/nthxdev" className="hover:text-primary transition-colors font-medium">nthxdev</Link> – Dynamic Text Effects
          </p>
        </div>
      </section>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="flex flex-col lg:flex-row gap-12 items-center">
              ...
              <div className="flex-1 relative max-w-6xl mx-auto">
                ...
                <div className="absolute -inset-6 bg-gradient-to-br from-purple-500/20 via-pink-500/20 to-blue-500/20 rounded-3xl blur-2xl opacity-60" />
            ...
            <div className="mt-20 text-center">
              ...
              <div className="flex justify-center gap-3 mb-16">
                {['css', 'animation', 'typography', 'fluid'].map((tag) => (
                  <span
                    key={tag}
                    className="px-4 py-2 bg-gradient-to-r from-purple-500/10 to-pink-500/10 border border-purple-500/20 rounded-full text-sm font-medium text-purple-600 hover:bg-purple-500/20 transition-colors cursor-default"
                  >
                    {tag}
                  </span>
                ))}
                ...
                <div className="relative aspect-video bg-gradient-hero overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity flex items-end justify-between p-4">
                    ...
                    <div className="text-white">
                      ...
                      <h3 className="font-bold text-lg">Shape Morphing</h3>
                    </div>
              ...
              <Card className="overflow-hidden group cursor-pointer hover:shadow-lg transition-all">
                <div className="relative aspect-video bg-gradient-hero overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity flex items-end justify-between p-4">
                    ...
                    <div className="text-white">
                      <p className="text-sm opacity-90">Element</p>
                      <h3 className="font-bold text-lg">Particle Background</h3>
                    </div>
...
export default FluidTypographyPortfolio;
